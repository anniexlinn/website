  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="flex items-center gap-1 text-xs text-[#5a534c] hover:text-pink-300 dark:text-pink-200 dark:hover:text-pink-100 transition-colors"
      >
        {theme === 'light' ? (
          ...
          <FiSun className="w-4 h-4 opacity-50" />
        )}
